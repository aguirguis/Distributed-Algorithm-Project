...
da_proc: da_proc.cpp
	...
	g++ -O0 -g3 -Wall -c -fmessage-length=0 -std=c++11 -MMD -MP -MF"lcb.d" -MT"lcb.o" -o "lcb.o" "lcb.cpp"
	...
	g++ -pthread -o "da_proc"  ./beb.o ./urb.o ./frb.o ./lcb.o ./da_proc.o ./perfect_link.o ./structures.o
